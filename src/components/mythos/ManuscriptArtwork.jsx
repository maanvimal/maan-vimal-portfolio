...
export function createManuscriptArtwork(type, width = 1024, height = 1400) {
  ...
  // 3. Black Manuscript Base (Solid / Near-Solid Pitch Black Surface)
  drawManuscriptBase(ctx, width, height)

  const cx = width * 0.5
  const cy = height * 0.50

  // 4. Left Quiescent Page (Completely clean, solid pitch black manuscript surface)
  if (type === 'left_quiescent_page' || type === 'left_folio_cosmic') {
    // Zero artwork, zero galaxies, zero stars — pure black manuscript
  }
...
export function createManuscriptGlowArtwork(type, width = 1024, height = 1400) {
  ...
  // 100% Transparent Background (Zero glow for left page)
  ...
  if (type === 'left_quiescent_page' || type === 'left_folio_cosmic') {
    // 100% Transparent, zero glow on left page
  } else if (type === 'page_01_phoenix' || type === 'right_folio_phoenix') {
